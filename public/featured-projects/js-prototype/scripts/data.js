const tours = [
    ...
    },
    {
        ...
        description:
            "Embark on an exhilarating journey through the vast deserts of Egypt. Explore sand dunes, ride camels, and witness breathtaking sunsets.",
        itinerary: {
            intro: "Discover the wonders of the desert with our expert guides.",
            schedule:
                "<ol><li>Camel Ride through the Desert</li><li>Sandboarding on Dunes</li><li>Traditional Bedouin Dinner</li></ol>",
        },
        length: "6 hours",
        start: "07/01/2024",
        end: "12/31/2024",
        ...
        guide: {
            ...
            info: [
                ...
                {
                    header: "Expertise",
                    content: ["Desert Travel", "Camel Riding", "Sandboarding"],
                },
    ...
    },
    {
        ...
        description:
            "Relax and enjoy a leisurely cruise along the iconic Nile River. Experience the beauty of ancient temples, bustling cities, and picturesque landscapes.",
        itinerary: {
            intro: "Explore Egypt's rich history and vibrant culture from the comfort of a luxury cruise ship.",
            schedule:
                "<ol><li>Visit Luxor and Karnak Temples</li><li>Explore the Valley of the Kings</li><li>Sail to Aswan and visit Philae Temple</li></ol>",
        },
        length: "3 days",
        start: "08/01/2024",
        end: "12/31/2024",
        ...
        guide: {
            ...
            info: [
                ...
                {
                    header: "Expertise",
                    content: ["History", "Archaeology", "Cruise Hosting"],
                },
